...
| Boolean Counter         | [boolean-counter.c](./src/divide-and-conquer/boolean-counter.c)     | Given an array [V V V F F] that always starts with V and subsequently with F, count the amount of F with divide and conquer.                                                                                                    |
| Array majority elements | [majority.c](./src/divide-and-conquer/majority.c)                   | Given an array with N elements, count the number of elements that have a majority in the array.                                                                                                                                 |
